...
Ext.define('Case.view.mynestedlist', {
    extend: 'Ext.dataview.NestedList',
    alias: 'widget.mynestedlist',

    requires: [
        'Case.view.mynestedlistViewModel',
        'Case.view.mynestedlistViewController'
    ],

    controller: 'mynestedlist',
    viewModel: {
        type: 'mynestedlist'
    },
    height: 400,
