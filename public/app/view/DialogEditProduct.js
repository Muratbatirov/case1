/*
 * File: app/view/DialogEditProduct.js
 *
...
Ext.define('Case.view.DialogEditProduct', {
    extend: 'Ext.Dialog',
    alias: 'widget.dialogEditProduct',

    requires: [
        'Case.view.DialogEditProductViewModel',
        'Case.view.DialogEditProductViewController',
        'Ext.form.Panel',
        'Ext.field.Container',
        'Ext.field.ComboBox',
        'Ext.XTemplate',
    ...
    controller: 'dialogeditproduct',
    viewModel: {
        type: 'dialogeditproduct'
    },
    docked: 'right',
    showAnimation: 'ddd',
    title: 'My Dialog',
